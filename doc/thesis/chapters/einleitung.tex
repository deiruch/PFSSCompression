...
Im Laufe des Projekts wurden drei Kompressionen entwickelt. Die Kompressionsraten sind der Tabelle \ref{einleitung:tabelle} ersichtlich. Die Visualisierung der komprimierten Daten kann in den Abbildungen \ref{bla} gesehen werden.
\begin{table}[!htbp]
	\center
	\begin{tabular}{r|l}
