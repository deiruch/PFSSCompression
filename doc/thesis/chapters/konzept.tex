...
\subsubsection{Quantisierung}
Der Vorteil der Rekursiver Linearer Kodierung liegt darin, dass der Kanal mit zwei bis drei Rekusionsstufen gut approximiert wird und die restlichen Vorhersagefehler minimal werden. Die minimalen Vorhersagefehler haben einen minimalen Einfluss auf die Rekonstruktion des Kanals. Die Vorhersagefehler werden für eine bessere Kompression quantisiert.
