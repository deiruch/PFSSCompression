...
namespace FITSFormatter
{
    class FitsReader
    {
        ...
        public static PFSSData ReadFits(FileInfo input, bool quantization) 
        {
            ...
            SimpleLineConstructor constructor = new SimpleLineConstructor(l0, b0, ptr, ptr_nz_len, ptph, ptth, quantization);

            return constructor.ConstructLines();
        }
